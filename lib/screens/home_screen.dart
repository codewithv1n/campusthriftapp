...
class _HomeScreenState extends State<HomeScreen> {
  String userName = 'Campus Student';
  ...
  Future<void> _loadUserData() async {
    ...
    setState(() {
      userName = prefs.getString('fullName') ?? 'Campus Student';
      studentId = prefs.getString('studentId') ?? 'student';
    });
  }
  ...
  Widget _buildNavItem(
    ...
    final activeGradient = isDark
        ? [const Color(0xFFFFF1B8), const Color.fromARGB(255, 91, 209, 104)]
        : [const Color(0xFFFFF1B8), const Color.fromARGB(255, 91, 209, 104)];
  ...
  void _showProfileOptions(BuildContext context) {
    ...
    showModalBottomSheet(
      ...
      isScrollControlled: true, // <-- important para full height scroll
      builder: (context) => DraggableScrollableSheet(
        expand: false, // hindi agad full height
        initialChildSize: 0.5, // start sa 50% height
        minChildSize: 0.3,
        maxChildSize: 0.9,
